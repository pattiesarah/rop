    ...
    <div class="col-md-9">
      ...
      <p><span>Provisions/ terms:</span>
        <ul>
          ...
          <li>To satisfy terms and requirements of export according to the restricted items.</li>
          <li>To fulfill terms and conditions of export (terms and conditions link)</li>
          <li>Export link of national products. </li>
        </ul>
      </p>
    </div>
