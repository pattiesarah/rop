...
<div class="container-fluid inner">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2><a href="home.php"><span>Home</span></a> > <a href="about.php"><span>About</span></a> > <a href="geography.php">Geographical Location</a></h2>
            </div>
            <div class="col-md-12">
                <h1>Geographical <span>Location</span></h1>
            </div>
        </div>
    </div>
</div>
